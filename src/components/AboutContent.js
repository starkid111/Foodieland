...
const AboutContent = () => {
    ...
    return ( 
        <div className='mt-24 lg:container lg:mx-auto '>
           <div className="flex flex-col md:flex-row justify-between md:space-x-10 p-5 overflow-hidden">
            
            {/**The left side */}
            <div className='flex flex-col space-y-6 md:w-2/3 overflow-hidden' data-aos="zoom-in-down">
              ...
              {/**The right side */}
              <div className='md:w-1/3 flex flex-col space-y-5 overflow-hidden' data-aos="zoom-in-down">
